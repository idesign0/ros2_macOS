...
# --- yaml-cpp from humble ROS 2 (opt/ vendor install) ---
set(yaml-cpp_DIR
    "$ENV{HOME}/humble-ros2/install/opt/yaml_cpp_vendor/lib/cmake/yaml-cpp"
    CACHE PATH "yaml-cpp config directory"
)

set(YAML_CPP_INCLUDE_DIRS
    "$ENV{HOME}/humble-ros2/install/opt/yaml_cpp_vendor/include"
    CACHE PATH "yaml-cpp include directory"
)

set(YAML_CPP_LIBRARIES
    "$ENV{HOME}/humble-ros2/install/opt/yaml_cpp_vendor/lib/libyaml-cpp.dylib"
